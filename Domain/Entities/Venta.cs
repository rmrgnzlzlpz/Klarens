...
namespace Domain.Entities
{
    public class Venta : Entity<int>
    {
        ...
        {
            if (detalles == null) throw new ArgumentException("Los detalles no pueden estar vac�os");
            if (detalles.Count < 1) throw new ArgumentException("Los detalles no pueden estar vac�os");
